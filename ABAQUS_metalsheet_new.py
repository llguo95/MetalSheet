...
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(0.0, 0.0),
                                                        point2=(1.0, 1.0))
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(0.5, 0.6 + h / 2.0),
                                                        point2=(0.9, 0.6 - h / 2.0))
mdb.models['Model-1'].sketches['__profile__'].CircleByCenterPerimeter(center=(
    0.25, 0.75), point1=(0.25, 0.75 + R))
...
mdb.models['Model-1'].HomogeneousShellSection(idealization=NO_IDEALIZATION,
                                              ...
                                              preIntegrate=OFF, temperature=GRADIENT, thickness=0.002,
                                              thicknessField='',
...
mdb.models['Model-1'].parts['Base_Model'].SectionAssignment(offset=0.0,
                                                            ...
                                                            mdb.models['Model-1'].parts['Base_Model'].sets[
                                                                'Set_Whole_Volume'],
                                                            sectionName='Sec_2mm_thick',
